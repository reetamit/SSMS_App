...
class _MailPageState extends State<MailPage> {
  ...
  // outlook
  final outlookSmtp = hotmail(
    dotenv.env["OUTLOOK_EMAIL"]!,
    dotenv.env["OUTLOOK_PASSWORD"]!,
  );

  // yandex mail
  final yandexSmtp = yandex(
    dotenv.env["YANDEX_EMAIL"]!,
    dotenv.env["YANDEX_PASSWORD"]!,
  );
  ...
  sendMailFromOutlook(String sender, sub, text) async {
    final message = Message()
      ..from = Address(dotenv.env["OUTLOOK_EMAIL"]!, 'Vollunteer Support Stuff')
      ..recipients.add(sender)
      ..subject = sub
      ..text = text;
